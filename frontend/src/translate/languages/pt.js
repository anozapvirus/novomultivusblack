    ...
    translations: {
      ...
      whatsappModal: {
        ...
        form: {
          ...
          geminiPrompt: "Prompt Sistema (instruções para Gemini)",
          geminiMaxTokens: "Máximo de tokens na resposta",
          geminiTemperature: "Temperatura (criatividade: 0-1)",
          geminiMaxMessages: "Máximo de mensagens de contexto",
          geminiTestPhone: "Número de WhatsApp para teste (formato: 5511999999999)"
        },
        buttons: {
          okAdd: "Adicionar",
          okEdit: "Salvar",
      ...
      queueIntegrationModal: {
        ...
        form: {
          ...
          geminiPrompt: "Prompt principal do Gemini",
          geminiMaxTokens: "Máximo de tokens por resposta",
          geminiTemperature: "Temperatura (criatividade)",
          geminiMaxMessages: "Máximo de mensagens no histórico",
          geminiTestPhone: "Número de WhatsApp para teste (formato: 5511999999999)",
          typeDescription: {
            dialogflow: "Dialogflow é uma plataforma conversacional que permite criar ótimos chatbots para WhatsApp.",
            n8n: "N8N permite criar automações com webhooks.",
            typebot: "Typebot permite criar lindos chatbots para WhatsApp.",
            gemini: "Gemini é a IA generativa do Google para criar conversas naturais.",
            webhook: "Webhook permite enviar notificações de mensagens para sistemas externos.",
            flowbuilder: "FlowBuilder permite criar fluxos de atendimento personalizados para WhatsApp."
          }
        },
        buttons: {
          okAdd: "Adicionar",
      ...
      queueIntegration: {
        ...
        form: {
          ...
          typebotSlug: "Typebot ID (slug)",
          typebotExpires: "Tempo de expiração (em horas)",
          typebotKeywordFinish: "Palavra-chave para encerrar",
          typebotKeywordRestart: "Palavra-chave para reiniciar",
          typebotRestartMessage: "Mensagem ao reiniciar",
          typebotUnknownMessage: "Mensagem para comandos desconhecidos",
          typebotDelayMessage: "Atraso entre mensagens (ms)",
          geminiApiKey: "Chave da API Gemini",
          geminiPrompt: "Prompt Sistema (instruções para Gemini)",
          geminiMaxTokens: "Máximo de tokens por resposta",
          geminiTemperature: "Temperatura (criatividade)",
