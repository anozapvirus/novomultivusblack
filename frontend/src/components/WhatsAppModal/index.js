                    ...
                    <div className={classes.importMessage}>
                      ...
                      >
                        <Typography variant="body2" style={{ color: '#1976d2' }}>
                          <strong>Importação de Mensagens:</strong> Para importar mensagens do WhatsApp, 
                          use o botão "Importar Mensagens" na página de conexões após salvar esta configuração.
                        </Typography>
                      </Paper>
                    </div>
