...
const TicketListItem = ({ ticket }) => {
    ...
    // Condição para exibir o ícone do Gemini
    const showGeminiIcon = 
        !ticket.queueId && 
        !ticket.userId && 
        ticket.whatsapp && 
        ticket.whatsapp.queueIntegrations && 
        ticket.whatsapp.queueIntegrations.type === 'gemini';
                ...
                <ListItemText
                    ...
                    primary={
                        <span className={classes.contactNameWrapper}>
                            ...
                            {/* Exibir o ícone do Gemini se a condição for atendida */}
                            {showGeminiIcon && (
                                <Tooltip title="Integração Gemini Ativa">
                                    <SmartToyIcon 
                                        fontSize="small" 
                                        style={{ marginLeft: 5, color: '#E91E63', verticalAlign: 'middle' }} 
                                    />
                                </Tooltip>
                            )}
                            {ticket.whatsappId && (
